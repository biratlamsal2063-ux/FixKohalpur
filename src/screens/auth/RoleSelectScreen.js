  ...
  return (
    <View style={[styles.screen, { paddingTop: insets.top, paddingBottom: insets.bottom }]}>
      ...
      <View style={styles.middle}>
        ...
        <TouchableOpacity style={styles.roleCard} onPress={function() { navigation.navigate('Login'); }} activeOpacity={0.85}>
          <View style={[styles.roleIcon, { backgroundColor: '#EBF4F9' }]}><Text style={{ fontSize: 32 }}>🏠</Text></View>
        ...
        <TouchableOpacity style={styles.roleCard} onPress={function() { navigation.navigate('ProviderRegister'); }} activeOpacity={0.85}>
          <View style={[styles.roleIcon, { backgroundColor: '#FFF0F1' }]}><Text style={{ fontSize: 32 }}>⚡</Text></View>
          <View style={styles.roleInfo}>
...
var styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: '#F1FAEE', justifyContent: 'space-between' },
  top: { backgroundColor: '#E63946', alignItems: 'center', paddingVertical: 48, paddingHorizontal: 24 },
  ...
  question: { fontSize: 18, fontWeight: '700', color: '#1D1D1D', marginBottom: 16, textAlign: 'center' },
  roleCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', borderRadius: 16, padding: 16, marginBottom: 14, borderWidth: 1, borderColor: '#EEEEEE', gap: 14, elevation: 2 },
  roleIcon: { width: 60, height: 60, borderRadius: 14, justifyContent: 'center', alignItems: 'center', flexShrink: 0 },
  roleInfo: { flex: 1 },
  roleTitle: { fontSize: 15, fontWeight: '700', color: '#1D1D1D', marginBottom: 4 },
  roleSub: { fontSize: 12, color: '#6B6B6B', lineHeight: 18 },
  bottom: { alignItems: 'center', paddingBottom: 24, gap: 6 },
